...
public class AuthenticatorActivity extends AccountAuthenticatorActivity {
    ...
    */
    ...
    protected Dialog onCreateDialog(int id) {
        switch (id) {
            ...
            case INVALID_SETTINGS_DIALOG:
                return new AlertDialog.Builder(this)
                        .setTitle(getString(R.string.login_activity_loginfail_text_both))
                        .setNegativeButton(getString(R.string.button_ok), new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int id) {
                                dialog.cancel();
                            }
            ...
            case INVALID_PASSWORD_DIALOG:
                return new AlertDialog.Builder(this)
                        .setTitle(getString(R.string.login_activity_loginfail_text_pwonly))
                        .setNegativeButton(getString(R.string.button_ok), new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int id) {
                                dialog.cancel();
                            }
        ...
        if (host.endsWith("gmail.com")) {
            ...
            try {
                ...
                for (Record record : records) {
                    ...
                    if (data.toLowerCase().endsWith("google.com.") || data.toLowerCase().endsWith("googlemail.com.")) {
                        return true;
                    }
                }
            } catch (Exception e) {
    ...
    private Thread attemptAuth(final AccountInfo accountInfo, final Handler handler,
